    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/main3.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/main3.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main3-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main3-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <p> Home / Shoes </p>
                        <h1> Leather Canvas Shoes Black </h1>
                        <h4> ₱2,924.00</h4>
                        <select>
