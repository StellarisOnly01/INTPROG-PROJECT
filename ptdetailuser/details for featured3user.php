    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Featured3.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Featured3.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured3-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured3-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="small-container">
                    <div class="row">
                        ...
                        <a href="details for featured4user.php"><h4> Hoodie Black </h4></a>d
                        <p> ₱2873.00 </p>
                        </div>
                    <div class="col-4"> 
