    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Featured4.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Featured4.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured4-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured4-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for featured2user.php"><img src="../images/Featured2.jpg"> </a>
                            <a href="details for featured2user.php"><h4>Baseball Hat Black </h4></a>
                            <p> ₱958.00 </p>
                            </div>
                            <div class="col-4"> 
                                <a href="details for featured3user.php"> <img src="../images/Featured3.jpg"> </a>
                                <a href="details for featured3user.php"><h4> Backpack Black </h4></a>
                                <p> ₱1916.00 </p>
                                </div>
                    <div class="col-4"> 
                        <a href="details for product10user.php"><img src="../images/product10.jpg"> </a>
                        <a href="details for product10user.php"><h4> Jogger Black </h4></a>
                        <p> ₱2682.00 </p>
                        </div>
                    </div>           
                </div>
