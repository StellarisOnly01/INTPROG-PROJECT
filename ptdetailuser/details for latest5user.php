    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Latest5.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Latest5.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Latest5-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Latest5-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <p> Home / Shoes </p>
                        <h1> Monster Clash Basketball Black </h1>
                        <h4> ₱3685.00</h4>
                        <select>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for latest6user.php"><img src="../images/Latest6.jpg"></a> 
                            <a href="details for latest6user.php"><h4> Vegas Lights Basketball Grey Purple </h4></a>
                            <p> ₱3685.00 </p>
                            </div>
                        <div class="col-4"> 
                            <a href="details for latest7user.php"><img src="../images/Latest7.jpg"> </a>
                            <a href="details for latest7user.php"><h4> Basketball White </h4></a>
                            <p> ₱2873.00 </p>
                            </div>
                            <div class="col-4"> 
