    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/product9.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/product9.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/product9-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/product9.jpg" width="100%" class="small-img">
                            </div>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            ...
                            <div class="col-4"> 
                                <a href="details for latest8user.php"><img src="../images/Latest8.jpg"></a> 
                                <a href="details for latest8user.php"><h4>  Pocket Pants Multicolor </h4></a>
                                <p> ₱2490.00 </p>
                                </div>
                                <div class="col-4"> 
                                    <a href="details for product11user.php"><img src="../images/product11.jpg"></a> 
                                    <a href="details for product11user.php"><h4> Socks Black </h4></a>
                                    <p> ₱575.00 </p>
                                    </div>
                    </div>           
                </div>
