    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Latest8.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Latest8.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Latest8-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Latest8-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for product9user.php"><img src="../images/product9.jpg"> </a>
                            <a href="details for product9user.php"><h4> Shorts Beige White </h4></a>
                            <p> ₱3065.00 </p>
                            </div>
                        <div class="col-4"> 
