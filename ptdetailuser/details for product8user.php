    ...
    <body>
        ...
        <div class="navbar">
            <div class="logo">
                ...
                <nav> 
                    <ul id="MenuItems">
                        <li><a href="../file/home-user-user.php">Home</a></li>
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <div class="small-img-row">
                            ...
                            <div class="small-img-col">
                                <img src="../images/product8-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/product8-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <p> Home / Shoes </p>
                        <h1> Draymond Green Player T Shirt </h1>
                        <h4> ₱1916.00</h4>
                        <select>
