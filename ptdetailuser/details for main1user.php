    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <button  onclick="window.history.back()" style="padding: 10px 10px;">Go back</button>
                <div class="row">
                    <div class="col-2">
                        
                        <img src="../images/main1.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/main1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main1-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main1-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <a href="../for cart.php" class="btn"> Add to Cart</a>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for product6user.php"><img src="../images/product6.jpg"> </a>
                            <a href="details for product6user.php"><h4> T Shirt Brown </h4></a>
                            <p> ₱958.00 </p>
                            </div>
                        <div class="col-4"> 
                        ...
                        <div class="col-4"> 
                            <a href="details for product8user.php"><img src="../images/product8.jpg"> </a>
                            <a href="details for product8user.php"><h4> Draymond Green Player T Shirt </h4></a>
                            <p> ₱1916.00 </p>
                            </div>
                    </div>           
                </div>
