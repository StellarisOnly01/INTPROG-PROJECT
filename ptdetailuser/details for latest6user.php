    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Latest6.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Latest6.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src=../images/Latest6-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Latest6-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <p> Home / Shoes </p>
                        <h1> Vegas Lights Basketball Grey Purple </h1>
                        <h4> ₱3685.00 </h4>
                        <select>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for latest1user.php"> <img src="../images/Latest1.jpg"> </a>
                            <a href="details for latest1user.php"><h4> Mid Skate Shoes Black </h4></a>
                            <p> ₱2873.00 </p>
                            </div>
                        <div class="col-4"> 
                            <a href="details for latest2user.php"><img src="../images/Latest2.jpg"> </a>
                            <a href="details for latest2user.php"><h4> Roses Skate Shoes Black </h4></a>
                            <p> ₱2873.00 </p>
                            </div>
                            <div class="col-4"> 
                                <a href="details for latest5user.php"><img src="../images/Latest5.jpg"> </a>
                                <a href="details for latest5user.php"><h4> Monster Clash Basketball Black </h4></a>
                                <p> ₱3685.00 </p>
                                </div>
                    </div>           
                </div>
