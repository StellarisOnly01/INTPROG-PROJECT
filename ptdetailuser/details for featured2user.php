        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                        <a href="details for main2user.php"><img src="../images/main2.jpg"> </a>
                        <a href="details for main2user.php"><h4> Reversible Hats </h4></a>
                        <p> ₱1,149.00 </p>
                        </div>
                    <div class="col-4"> 
                    ...
                    <div class="col-4"> 
                        ...
                        <a href="details for product4user.php"><h4> Black Shoes </h4></a>
                        <p> ₱2999.00 </p>
                        </div>
                    </div>           
                </div>
