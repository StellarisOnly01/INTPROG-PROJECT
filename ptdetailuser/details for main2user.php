...
<head>
    ...
    <body>
        ...
        <div class="navbar">
            <div class="logo">
                <a href="../file/home.php"><img src="../images/logo.png" width="45px"></a>
                </div>
                <nav> 
                    <ul id="MenuItems">
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/main2.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/main2.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main2-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/main2-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-4"> 
                            ...
                            <div class="col-4"> 
                                ...
                                <div class="col-4"> 
                                    <a href="details for featured1user.php"><img src="../images/Featured1.jpg"> </a>
                                    <a href="details for featured1user.php"><h4> Sunglasses Multicolor </h4></a>
                                    <p> ₱2643.00 </p>
                                    </div>
                    </div>           
                </div>
