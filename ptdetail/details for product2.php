    ...
    <body>
        ...
        <div class="navbar">
            <div class="logo">
                ...
                <img src="Cmenu.png" class="menu-icon" onclick="menutoggle()">
            </div>
            </div>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        ...
                        <div class="small-img-row">
                            ...
                            <div class="small-img-col">
                                <img src="../images/product2-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/product2-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for product1.php"><img src="../images/product1.jpg"> </a>
                            <a href="details for product1.php"><h4> Sunglasses Gold </h4></a>
                            <p> ₱3410.00 </p>
                            </div>
                            <div class="col-4"> 
                                <a href="details for product3.php"> <img src="../images/product3.jpg"> </a>
                                <a href="details for product3.php"><h4> Sunglasses Dark Grey </h4></a>
                                <p> ₱2260.00 </p>
                                </div>
                                <div class="col-4"> 
                                    <a href="details for product4.php"> <img src="../images/product4.jpg"> </a>
                                    <a href="details for product4.php"><h4> Sunglasses Gold / Black </h4></a>
                                    <p> ₱3410.00 </p>
                                    </div>
                    </div>           
                </div>
