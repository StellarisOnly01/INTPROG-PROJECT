    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        <img src="../images/Featured2.jpg" width="100%" id="ProductImg">

                        <div class="small-img-row">
                            <div class="small-img-col">
                                <img src="../images/Featured2.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured2-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured2.jpg" width="100%" class="small-img">
                            </div>
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                        <a href="details for main2.php"><img src="../images/main2.jpg"> </a>
                        <a href="details for main2.php"><h4> Reversible Hats </h4></a>
                        <p> ₱1,149.00 </p>
                        </div>
                    <div class="col-4"> 
                    ...
                    <div class="col-4"> 
                        ...
                        <a href="details for product4.php"><h4> Black Shoes </h4></a>
                        <p> ₱2999.00 </p>
                        </div>
                    </div>           
                </div>
