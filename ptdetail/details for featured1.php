        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <div class="row">
                    <div class="col-2">
                        ...
                        <div class="small-img-row">
                            ...
                            <div class="small-img-col">
                                <img src="../images/Featured1-1.jpg" width="100%" class="small-img">
                            </div>
                            <div class="small-img-col">
                                <img src="../images/Featured1-2.jpg" width="100%" class="small-img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="small-container">
                    ...
                    <div class="col-4"> 
                        <a href="details for product2.php"><img src="../images/product2.jpg"> </a>
                        <a href="details for product2.php"><h4> Sunglasses Black </h4></a>
                        <p> ₱3027.00 </p>
                        </div>
                    <div class="col-4"> 
