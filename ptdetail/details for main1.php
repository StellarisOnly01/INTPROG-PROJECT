    ...
    <body>
        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                <button  onclick="window.history.back()" style="padding: 10px 25px; border-radius: 10px; cursor: pointer; "><img src="../images/arrow.png" style="
  width: 14px; margin-right: 5px">Go back</button>
                <div class="row">
                    <div class="col-2">
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for product6.php"><img src="../images/product6.jpg"> </a>
                            <a href="details for product6.php"><h4> T Shirt Brown </h4></a>
                            <p> ₱958.00 </p>
                            </div>
                        <div class="col-4"> 
