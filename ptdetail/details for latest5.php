        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for latest6.php"><img src="../images/Latest6.jpg"></a> 
                            <a href="details for latest6.php"><h4> Vegas Lights Basketball Grey Purple </h4></a>
                            <p> ₱3685.00 </p>
                            </div>
                        <div class="col-4"> 
                            <a href="details for latest7.php"><img src="../images/Latest7.jpg"> </a>
                            <a href="details for latest7.php"><h4> Basketball White </h4></a>
                            <p> ₱2873.00 </p>
                            </div>
                            <div class="col-4"> 
                                <a href="details for latest1.php"> <img src="../images/Latest1.jpg"> </a>
                                <a href="details for latest1.php"><h4> Mid Skate Shoes Black </h4></a>
                                <p> ₱2873.00 </p>
                                </div>
                    </div>           
                </div>
