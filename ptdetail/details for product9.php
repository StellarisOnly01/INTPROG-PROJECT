        ...
        <!--Product Details-->
            ...
            <div class="small-container single-product">
                ...
                <div class="small-container">
                    <div class="row">
                        <div class="col-4"> 
                            <a href="details for product10.php"><img src="../images/product10.jpg"> </a>
                            <a href="details for product10.php"><h4> Jogger Black </h4></a>
                            <p> ₱2682.00 </p>
                            </div>
                            <div class="col-4"> 
                                <a href="details for latest8.php"><img src="../images/Latest8.jpg"></a> 
                                <a href="details for latest8.php"><h4>  Pocket Pants Multicolor </h4></a>
                                <p> ₱2490.00 </p>
                                </div>
                                <div class="col-4"> 
                                    <a href="details for product11.php"><img src="../images/product11.jpg"></a> 
                                    <a href="details for product11.php"><h4> Socks Black </h4></a>
                                    <p> ₱575.00 </p>
                                    </div>
                    </div>           
                </div>
